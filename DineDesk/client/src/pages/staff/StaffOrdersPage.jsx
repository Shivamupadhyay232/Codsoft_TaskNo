import { Eye, Filter, RefreshCw, Search, ShoppingBag } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div>
          <h1 className="text-2xl font-bold font-serif text-slate-900">Live Orders Management</h1>
          <p className="text-xs text-slate-500">Monitor incoming dining, takeaway, and delivery orders</p>
        </div>
      ...
      {/* Orders Table */}
      {loading ? (
        <LoadingSpinner text="Fetching orders feed..." />
      ) : orders.length === 0 ? (
        <EmptyState
          icon={ShoppingBag}
